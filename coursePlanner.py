...
def balanced_topological_sort(graph, max_classes_per_semester, max_total_courses, taken_courses):
...
def main():  
    ...
    sorted_courses = balanced_topological_sort(graph, max_classes_per_semester, max_total_courses, taken_courses)
